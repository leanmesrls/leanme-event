  ...
  return (
    ...
    >
      <div
        ...
        className={`leonardo-canvas flex max-h-[94vh] w-full ${maxWidthClassName} flex-col overflow-hidden rounded-t-2xl border border-zinc-300/80 bg-[#f0f0f3] shadow-2xl sm:rounded-2xl`}
      ...
      >
        ...
        {footer ? (
          <div className="shrink-0 border-t border-zinc-300/70 bg-[#e6e6ec] px-4 py-3 sm:px-5">
            {footer}
          </div>
        ) : null}
      </div>
