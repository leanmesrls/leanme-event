...
import { todayEuropeanDate } from "@/lib/lean-event/dates";
import type { LeonardoMeetingType } from "@/types/lean-event";
...
export function LeonardoWorkspaceForm({
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    const response = await fetch("/api/lean-event/workspaces", {
      method: "POST",
    ...
    window.location.assign(
      leanEventLeonardoWorkspacePath(tenantSlug, payload.workspace.id)
    );
  }
