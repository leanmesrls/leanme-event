...
} from "@/lib/lean-event/workspace-search";
import { sortWorkspaces, type ListSortMode } from "@/lib/lean-event/list-sort";
import {
...
export function LeonardoWorkspaceList({
  ...
  async function handleDelete(id: string) {
    const response = await fetch(`/api/lean-event/workspaces/${id}`, {
      method: "DELETE",
